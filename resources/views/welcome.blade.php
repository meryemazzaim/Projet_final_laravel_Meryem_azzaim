...
@section('content') --}}
    ...
    {{-- <header class="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">
                    <div class="flex lg:justify-center lg:col-start-2 text-white hover:bg-gray-700">
                        <h1> <i><u><b>E M S</b></u></i></h1>
    ...
    {{-- <div class="flex w-full h-screen">
        ...
        <img width="900" src="{{ asset('images/event.jpeg') }}" class=" object-cover md:h-96" alt="Workspace Image">
    </div> --}}
{{-- @endsection --}}
